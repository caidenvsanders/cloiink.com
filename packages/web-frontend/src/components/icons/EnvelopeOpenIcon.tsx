...
interface IEnvelopeOpenIconProps {
  width: string;
  color: string;
  theme: Theme;
}
 ...
 * @param {string} color
 */
export const EnvelopeOpenIcon = withTheme(
  ({ width, color, theme }: IEnvelopeOpenIconProps) => {
...
export default withTheme(EnvelopeOpenIcon);
